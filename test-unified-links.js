...
const testBlocksWithLinks = [
  ...
  },
  {
    ...
    data: {
      ...
      items: [
        ...
        {
          content: 'Second item with <a href="https://link2.com">another link</a>',
          meta: {},
          items: [
  ...
  },
  {
    ...
    data: {
      ...
      caption: 'Image caption with <a href="https://caption-link.com">link in caption</a>',
      withBorder: false,
  ...
  },
  {
    ...
    data: {
      ...
      width: 580,
      height: 320,
      caption: 'Document with <a href="https://doc-link.com">link in caption</a>',
    },
  },
  {
    type: "paragraph",
...
async function testUnifiedLinksParser() {
  try {
    console.log("Testing EditorJS to Markdown parser with unified ecosystem for HTML links...\n");
    ...
    expectedPatterns.forEach((pattern, index) => {
      if (pattern.test(markdown)) {
        ...
        console.log(`❌ Test ${index + 1}: Link pattern NOT matched - ${pattern}`);
